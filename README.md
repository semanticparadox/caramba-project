...
**Последняя ранее выпущенная версия — 0.9.97.** Выпуск **0.9.98 готовится**:
новые возможности ниже помечены отдельно. Подготовленные изменения описаны
в [предварительных примечаниях](docs/releases/0.9.98.md).

**0.9.98 — единый номер нового выпуска:** панель, установщик, узлы, бот и все
приложения Caramba Connect. Сборки проходят заключительную проверку; ссылки
скачивания и установка с нового адреса станут доступны после публикации.
...
GIF и предпросмотром. [Что изменится →](docs/releases/0.9.98.md)

## Free и Full

В выпуске **0.9.98** будут доступны две редакции панели:
...
Ссылки ниже станут доступны после публикации **0.9.98**. В новом публичном
репозитории бинарный выпуск пока не опубликован.
Архивные исходники в Releases относятся к прошлым версиям и не являются новым
выпуском приложений.
...
| Платформа | Файлы готовящегося выпуска |
| :--- | :--- |
...
[Страница выпуска после публикации](https://github.com/semanticparadox/caramba-project/releases/latest) ·
...
подписки **после публикации серверного выпуска 0.9.98**. Для действующего сервиса
