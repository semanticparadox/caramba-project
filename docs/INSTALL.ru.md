...
[← Документация](README.ru.md) · [English](INSTALL.md) | **Русский** · [Обновить установленную панель](UPGRADING.ru.md)

Это инструкция для владельца сервиса. Если вы хотите только подключиться к VPN,
перейдите к [Caramba Connect](CONNECT.ru.md).
...
Обновление существующей Caramba выполняется по [отдельной инструкции](UPGRADING.ru.md).
...
[Условия использования](../LICENSE.ru.md).

Дальше: [руководство панели](PANEL.ru.md) · [резервное копирование и обновление](UPGRADING.ru.md).
