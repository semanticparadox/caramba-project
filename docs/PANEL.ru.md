...
[← Документация](README.ru.md) · [English](PANEL.md) | **Русский** · [Установка](INSTALL.ru.md) · [Поддержка](https://t.me/caramba_support)
...
После [установки](INSTALL.ru.md) войдите под владельцем. Добавьте VPN-сервер, дождитесь
...
лицензий пока не открыта. [Условия редакций](../LICENSE.ru.md).
...
читайте [порядок обновления](UPGRADING.ru.md) и примечания конкретного выпуска.
