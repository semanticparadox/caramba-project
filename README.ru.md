...
<p align="center"><a href="#скачать-caramba-connect">Скачать</a> · <a href="#установить-панель">Установить</a> · <a href="docs/UPGRADING.ru.md">Обновить</a> · <a href="docs/README.ru.md">Документация</a> · <a href="https://t.me/caramba_support">Поддержка</a></p>
...
Внутренний номер сборки Connect — **112**. [Примечания к выпуску](docs/releases/0.9.98.ru.md).

## Выберите свой путь

| Мне нужно… | С чего начать |
| :--- | :--- |
| Подключиться к своему провайдеру | [Скачать Caramba Connect](#скачать-caramba-connect) и [добавить подключение](docs/CONNECT.ru.md). |
| Запустить собственный сервис | [Установить панель](docs/INSTALL.ru.md), добавить сервер и выдать первую подписку. |
| Обновить действующую установку | [Порядок обновления и резервная копия](docs/UPGRADING.ru.md). |
| Разобраться с панелью | [Руководство владельца](docs/PANEL.ru.md). |
...
GIF и предпросмотром. [Что нового →](docs/releases/0.9.98.ru.md)
...
[Как активировать Full](docs/LICENSING.ru.md) · [Условия использования](LICENSE.ru.md).
...
[Как установить и подключиться](docs/CONNECT.ru.md)
...
[Пошаговая установка](docs/INSTALL.ru.md) проведёт от подготовки сервера до первой
подписки. Для действующего сервиса
сначала прочитайте [руководство по обновлению](docs/UPGRADING.ru.md).

## Помощь и документы

- [Руководство панели](docs/PANEL.ru.md) — пользователи, серверы, ключи, сообщения и команда.
- [Подключение и частые вопросы](docs/CONNECT.ru.md) — помощь пользователю Caramba Connect.
- [Вся документация](docs/README.ru.md) — установка, обновление и условия использования.
- [Лицензии](LICENSE.ru.md) · [Сторонние компоненты](docs/legal/THIRD_PARTY.md) · [Соответствующие исходники](docs/legal/SOURCE_AVAILABILITY.ru.md).
